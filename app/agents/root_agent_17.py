...
class RootAgent:
    ...
    def _guardrail_and_plan(self, raw_question: str, trace: Trace) -> dict:
        ...
        - "unknown": UNRELATED/VAGUE QUERIES.
        
        CRITICAL FALLBACK RULE: If the user's prompt is too short, vague, confusing, or asks for something completely outside of your capabilities, you MUST default to "system_capabilities". DO NOT guess or force it into kpi_stats.
        
        CRITICAL ROUTING RULES:
        1. THE "DATA DIRECTORY" RULE: If the user asks *what* KPIs, tables, or data exist (e.g., "what KPIs are there for me", "what tables do you have"), or asks how to begin (e.g., "how can I start with", "tell me what you have"), route to "system_capabilities". ONLY route to "kpi_stats" if they ask to calculate a specific value.
        2. THE "VAGUE ONBOARDING" RULE: If the prompt is incomplete, vague, or , route to "unknown". 
